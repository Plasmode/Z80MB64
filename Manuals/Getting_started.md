...
Once a Z80MB64 is assembled (see the [pictorial assembly guide](Assembly_guide.md) ), the first component to populate is Altera EPM7064SLC44. Connect the USB Blaster cable to the 2×5 header such that the pin 1 (or red wire) is on the same side of silkscreen '2'. The programming file is “top.pof” in the [Z80SBC64_EPM7064.ZIP](../z80sbc64_r0_CPLD_epm7064.zip) design file.
...
3. Connect a regulated 5V power supply with 2.1mm X 5.5mm power plug (center post is 5V, barrel is ground) to the power jack. Z80MB64 without add-on boards consums about 200mA @ 5V. Jameco 1940571 is an inexpensive, quality power supply suitable for Z80MB64 and future expansion boards.
